...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Speed Team'],
			['N30',					'N30',				'Main Programmer, Charter, and Sprite Artist',		'https://www.instagram.com/n30_22/',		'444444'],
			['WatchParty',			'dog',				'Where it all Began',									'https://adryd.co/wits.mp4',			'C30085'],
			['Darren Watkins',		'Speed',			'The Gay Man Himself',							'https://www.youtube.com/c/IShowSpeed',			'389A58'],
			[''],
			["Funkin' Crew"],
